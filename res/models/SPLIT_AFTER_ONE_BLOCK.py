...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x):
        ...
        x_2_1 = self.layer2_1(x)
        x_3_1 = self.layer3_1(x_2_1)
        x_4_1 = self.layer4_1(x_3_1)
        x_pool_1 = self.avgpools_1(x_4_1)
        x_flats_1 = torch.flatten(x_pool_1, 1)
        x_out_1 = self.fc_1(x_flats_1)

        x_2_2 = self.layer2_2(x)
        x_3_2 = self.layer3_2(x_2_2)
        x_4_2 = self.layer4_2(x_3_2)
        x_pool_2 = self.avgpools_2(x_4_2)
        x_flats_2 = torch.flatten(x_pool_2, 1)
...
#         outs = [fc_layer(x) for fc_layer in self.fcs]
    ...
    def get_activations(self, x, layer_name):
        ...
        if layer_name == 'block2':
            activations_dict['%s_rotation'%layer_name] = x_2_1
            activations_dict['%s_model'%layer_name] = x_2_2
            return activations_dict
        
        x_3_1 = self.layer3_1(x_2_1)
        x_3_2 = self.layer3_2(x_2_2)
        if layer_name == 'block3':
            activations_dict['%s_rotation'%layer_name] = x_3_1
            activations_dict['%s_model'%layer_name] = x_3_2
            return activations_dict
        ...
        if layer_name == 'block4':
            activations_dict['%s_rotation'%layer_name] = x_4_1
            activations_dict['%s_model'%layer_name] = x_4_2
            return activations_dict
        ...
        if layer_name == 'pre_fc':
            activations_dict['%s_rotation'%layer_name] = x_flats_1
            activations_dict['%s_model'%layer_name] = x_flats_2
            return activations_dict
