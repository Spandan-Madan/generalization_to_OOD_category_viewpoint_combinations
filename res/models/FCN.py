...
#     def __init_(self, in_channels, out_channels, kernel_conv, stride_conv, padding_conv, kernel_pool,stride_pool):
#         super(Conv_Block,self).__init__()
        
#         self.layer = nn.Sequential(nn.Conv2d(3, 64, kernel_size=kernel_conv, stride=stride_conv, padding=padding_conv),
