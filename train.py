...
if TASK == 'combined':
    ...
    SAVE_FILE = 'logs/%s_%s_%s_%s_%s_%s_%s.out'%(train_file_name, TASK, ARCH, DATASET_NAME, NUM_EPOCHS, BATCH_SIZE, SAVE_FILE_SUFFIX)
...
if TASK == 'combined':
    with open('saved_models/%s_model_%s_%s_%s.pt'%(train_file_name, ARCH, DATASET_NAME,SAVE_FILE_SUFFIX),'wb') as F:
        torch.save(best_model,F)

    with open('losses/%s_losses_%s_%s_%s.pt'%(train_file_name, ARCH, DATASET_NAME,SAVE_FILE_SUFFIX),'wb') as F:
        pickle.dump(losses,F)

    with open('accuracies/%s_accuracies_%s_%s_%s.pt'%(train_file_name, ARCH, DATASET_NAME,SAVE_FILE_SUFFIX),'wb') as F:
        pickle.dump(accuracies,F)
else:
    with open('saved_models/%s_%s_model_%s_%s_%s.pt'%(train_file_name, TASK, ARCH, DATASET_NAME,SAVE_FILE_SUFFIX),'wb') as F:
        torch.save(best_model,F)

    with open('losses/%s_%s_losses_%s_%s_%s.pt'%(train_file_name, TASK, ARCH, DATASET_NAME,SAVE_FILE_SUFFIX),'wb') as F:
        pickle.dump(losses,F)

    with open('accuracies/%s_%s_accuracies_%s_%s_%s.pt'%(train_file_name, TASK, ARCH, DATASET_NAME,SAVE_FILE_SUFFIX),'wb') as F:
        pickle.dump(accuracies,F)
...
if TASK == 'combined':
    with open('accuracies/%s_test_accuracies_%s_%s_%s.pt'%(train_file_name, ARCH, DATASET_NAME, SAVE_FILE_SUFFIX),'wb') as F:
        pickle.dump(test_epoch_accs,F)
else:
    with open('accuracies/%s_%s_test_accuracies_%s_%s_%s.pt'%(train_file_name, TASK, ARCH, DATASET_NAME, SAVE_FILE_SUFFIX),'wb') as F:
        pickle.dump(test_epoch_accs,F)
